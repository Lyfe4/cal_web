...
const BlueprintCard = () => (
  <figure className="blueprint-card">
    ...
    >
      ...
      <g className="g-page">
        <rect
          className="bp-line bp-frame bp-stroke"
          pathLength="1"
          x="16"
          y="24"
          width="284"
      ...
      <g className="g-dims">
        ...
        <text className="bp-dim-label bp-soft" x="158" y="9" textAnchor="middle">
          responsive
        </text>
        ...
        <text
          className="bp-dim-label bp-soft"
          x="332"
          y="162"
          textAnchor="middle"
          transform="rotate(-90 332 162)"
        >
          1200 px
        </text>
      </g>
